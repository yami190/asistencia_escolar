        ...
        <div class="col-12">
          <div class="card collapsed-card">
            <div class="card-header">
              <h3 class="card-title">Balances Por Sectores</h3>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="balance in arraybalance" >
                      <td v-text="formatPrice(balance.filas)"></td>
                      <td v-text="formatPrice(Number(balance.ahorro))"></td>
                      <td v-text="formatPrice(Number(balance.ahorro))"></td>
                      <td v-text="formatPrice(Number(balance.prestamos))"></td>
                      <td v-text="formatPrice(Number(balance.seguro))"></td>
                      <td v-text="formatPrice(Number(balance.ahorro * 2) + Number(balance.prestamos) + Number(balance.seguro))"></td>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card collapsed-card">
            <div class="card-header">
              <h3 class="card-title">Balances por nominas</h3>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <select class="form-control" v-model="sud_gremio">
                      ...
                      <option value="12">JUB. EDUCACIÓN</option>
                    </select>
                  </div>
                </div>
                <div class="col-sm-2">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="balance in arraybalancesud" >
                      ...
                      <td v-text="formatPrice(Number(balance.prestamos))"></td>
                      <td v-text="formatPrice(Number(balance.seguro))"></td>
                      <td v-text="formatPrice(Number(balance.ahorro) + Number(balance.prestamos) + Number(balance.seguro))"></td>
                      <td v-text="balance.mes"></td>
                      <td v-text="balance.ano"></td>
                    </tr>
                  </tbody>
